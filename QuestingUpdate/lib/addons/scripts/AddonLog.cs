...
namespace QuestingUpdate.lib.addons.scripts
{
    class AddonLog
    {
        public static readonly string path = System.Environment.GetEnvironmentVariable("USERPROFILE") + "/appdata/locallow/volcanoid/volcanoids/mods/resources/logs/Addon.log";
